...
`
  ...
  return (
    <Accordion>
      <AccordionItem header={verilerName3}>
      <Divv1 >
            <p> gender:{verilerGender3}</p>
            <p>Height:{verilerHeight3}</p>
            <p> Mass:{verilerMass3}</p>
            <p>BirthYear:{verilerBirthYear3}</p>
            <p>Eye Color:{verilerEyeColor3} </p>
            <p> Hair Color:{verilerHairColor3}</p>
            <p>Skin Color:{verilerSkinColor3}</p>
